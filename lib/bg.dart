...
class _resgisterbookState extends State<resgisterbook> {
  ...
  void adds() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Có lỗi xảy ra khi thêm sách.'),
  ...
  Future<void> pickImage() async {
    ...
    if (image != null) {
      ...
      setState(() {
        _imagePath = base64Image; // Lưu ảnh dưới dạng Base64
        _imageName = image.name; // Lưu tên file ảnh
      });
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        _imagePath == null ? 'Chọn ảnh' : 'Ảnh đã chọn',
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text(
            ...
            style: TextStyle(color: Color.fromARGB(255, 245, 126, 47)),
          ),
          iconTheme: const IconThemeData(color: Colors.white),
          backgroundColor: Colors.black,
          centerTitle: true,
          flexibleSpace: Container(
            decoration: const BoxDecoration(
                border: Border(
                    bottom: BorderSide(
                        color: Color.fromARGB(255, 247, 83, 18), width: 1))),
          ),
          actions: [
            IconButton(
                onPressed: () {
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      style: const TextStyle(color: Colors.white),
                      decoration: const InputDecoration(
                        labelText: 'Cập Nhật nhà xuất bản',
                        labelStyle: TextStyle(color: Colors.white),
                        enabledBorder: OutlineInputBorder(
                            borderSide:
                                BorderSide(color: Colors.white, width: 2)),
                    ...
                    TextField(
                      ...
                      style: const TextStyle(color: Colors.white),
                      decoration: const InputDecoration(
                        labelText: 'Cập Nhật năm suất bản',
                        labelStyle: TextStyle(color: Colors.white),
                        enabledBorder: OutlineInputBorder(
                            borderSide:
                                BorderSide(color: Colors.white, width: 2)),
