          ...
          return SignInScreen(
            ...
            actions: [
              AuthStateChangeAction<SignedIn>((context, state) async {
                await users
                    .checkFirstTimeUser(); // Gọi phương thức checkFirstTimeUser
...
class _TheListState extends State<TheList> {
  ...
  void initState() {
    super.initState();
    theList =
        savebook.getbook(); // Giả định rằng bạn có hàm này để lấy dữ liệu sách
  }
          ...
          child: Scaffold(
              appBar: AppBar(
                ...
                title: userRole == 'admin'
                    ? const Text('Sách Tri Thức (Admin)',
                        style: TextStyle(
                            color: Color.fromARGB(255, 255, 255, 255),
                            fontSize: 20))
                    : const Text('Sách Tri Thức',
                        style: TextStyle(
                            color: Color.fromARGB(255, 255, 255, 255),
                            fontSize: 25)),
                                      ...
                                      title: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            const SizedBox(
                                                width:
                                                    15), // Khoảng cách giữa ảnh và text
                                            Expanded(
                                              child: Column(
                                                crossAxisAlignment:
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content:
              const Text('Bạn có muốn chỉnh sửa thông tin cho sách này không?'),
          actions: <Widget>[
            TextButton(
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        BookUpdatePage(bookId: selectedBook.id),
                  ),
                );
              },
            ),
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
                'bạn có chắc muốn xóa danh sách của cuốn sách: ${book.name}'),
            actions: [
              TextButton(
                  onPressed: () {
                    Navigator.of(context).pop();
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Đã xóa thành công sách có quyển sách tên: ${book.name}'),
                          actions: [
                            TextButton(
                              onPressed: () {
                                Navigator.of(context).pop();
